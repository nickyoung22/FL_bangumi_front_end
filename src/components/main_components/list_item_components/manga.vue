<template>
  <div class="list-item">
    ...
    <div class="title-box clearfix">
      ...
      <span class="artist artist_highlight float-right">{{ list_item_data.artist.join(' -- ') }}</span>
    </div>
        ...
        <div class="filenames-box-wrapper clearfix">
          <div class="filenames-box float-right">
            ...
            <span class="img-info display-inline-block">
              <File_icon class="file-names click-active hover-active" fileName='图片信息' @click="open_in_chnMangaReader"
                v-bind="{
            ...
            <template v-for="file in file_names_need_show">
              <File_icon class="file-names click-active hover-active" :fileName="file"
                @click="open(list_item_data.type, list_item_data.storeName, file)" v-bind="{
                  url_exact: true,
                  tooltip_direction: 'left-end'
                }">
              </File_icon>
...
export default {
  ...
  computed: {
    ...
    file_names_need_show() {
      return this.list_item_data.file_names.filter(
        e => this.file_name_need_show(e)
      )
    },
