    ...
    <div class="left">
      ...
      <Infinite_list :type="type" :list_data="list_data_filtered_from_store">
        <template v-slot:list_item_component="slot_data">
          <!-- // 需要配置的地方 -->
          <Manga :list_item_data="slot_data.list_item_data"></Manga>
        </template>
      </Infinite_list>
    </div>
    <div class="right">
...
import Manga from '../main_components/list_item_components/Manga.vue'  // 需要配置的地方
...
export default {
  ...
  data() {
    return {
      ComponentName: 'main_2CY_manga.vue',  // 需要配置的地方
      type: '',
      filter_fields: []
    }
  },
