    ...
    <div class="left">
      ...
      <Infinite_list :type="type" :list_data="list_data_filtered_from_store">
        <template v-slot:list_item_component="slot_data">
          <!-- // 需要配置的地方 -->
          <Dance :list_item_data="slot_data.list_item_data"></Dance>
        </template>
      </Infinite_list>
    </div>
    <div class="right">
...
import Dance from '../main_components/list_item_components/dance.vue'  // 需要配置的地方
...
export default {
  ...
  data() {
    return {
      ComponentName: 'main_3CY_dance.vue',  // 需要配置的地方
      type: '',
      filter_fields: []
    }
  },
