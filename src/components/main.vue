        ...
        <div class="left">
            ...
            <Infinite_list :type="type" :list_data="list_data_filtered_from_store">
                <template v-slot:list_item_component="slot_data">
                    <component :is="item_component_name" :list_item_data="slot_data.list_item_data">
                    </component>
                </template>
            </Infinite_list>
        </div>
...
export default {
    ...
    computed: {
        list_data_filtered_from_store() {
            return this.store['list_data_filtered'][this.type] ? this.store['list_data_filtered'][this.type] : []
        }
    },
    methods: {
    },
