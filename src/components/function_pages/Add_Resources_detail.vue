<template>
  <div class="main_func">
    <div class="form-box">
      <template v-for="item in format" :key="item.name">
        ...
        <template v-if="item.show">
          <div class="form-box-row" :class="{
            empty: (item.type === 'String' && item.value === '') ||
            ...
            <template v-else-if="item.type === 'Date'">
              <el-config-provider :locale="zhCn">
                <el-date-picker v-model="item.value" type="date" placeholder="陈浩楠，请Pick a day" format="YYYY/MM/DD"
    ...
    <div class="submit-box">
      ...
      <el-popconfirm confirm-button-text="确认" cancel-button-text="取消" cancel-button-type="info" title="你确认要添加本资源吗？"
        @confirm="submit">
        <template #reference>
      ...
      <template v-if="operation === 'modify'">
        <el-popconfirm confirm-button-text="确认删除" confirm-button-type="danger" cancel-button-text="取消"
          cancel-button-type="info" title="你确认要从数据库删除本资源吗？" @confirm="delete_from_db">
          <template #reference>
