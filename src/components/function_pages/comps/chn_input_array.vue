  ...
  <div class="inputs">
      ...
      <div class="inputs-row">
        ...
        <span class="button-placehodler">
          <span class="button-hidden">
            <el-button @click="deleteItem(index)" type="danger" :icon="CloseBold" size="small" circle></el-button>
          </span>
        </span>
      </div>
    </template>
    ...
    <div class="inputs-row2 clearfix">
      <div class="add-button-wrapper float-right">
        <el-button class="add-button" @click="addItem" type="primary" :icon="Plus" size="small" circle></el-button>
      </div>
    </div>
  </div>
</template>
